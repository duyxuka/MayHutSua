...
import DangKyPage from './dangky';

const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://mayhutsua.com.vn';

export async function generateMetadata(): Promise<Metadata> {
  try {
    const seo = await getSeoByPageKey('DangKy');
    const title = seo?.seoTitle || 'Đăng ký';
    ...
    return {
      ...
      alternates: {
        canonical: `${siteUrl}/dang-ky`,
      },
    };
  } catch {
    return {
      title: 'Đăng ký',
      description: 'Đăng ký tài khoản tại mayhutsua.com.vn',
