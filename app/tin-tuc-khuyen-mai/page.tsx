...
import TinTucKhuyenMaiPage from './tintuckhuyenmai';

const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://mayhutsua.com.vn';

export async function generateMetadata(): Promise<Metadata> {
  try {
    const seo = await getSeoByPageKey('TinTucKhuyenMai');
    const title = seo?.seoTitle || 'Tin tức - Khuyến mãi';
    ...
    return {
      ...
      openGraph: {
        ...
        url: `${siteUrl}/tin-tuc-khuyen-mai`,
      ...
      alternates: {
        canonical: `${siteUrl}/tin-tuc-khuyen-mai`,
      },
    };
  } catch {
    return {
      title: 'Tin tức - Khuyến mãi',
      description: 'Tin tức và khuyến mãi từ mayhutsua.com.vn',
